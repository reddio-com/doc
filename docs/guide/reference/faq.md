...
You must make sure your ERC721 contract includes the [MintFor]([https://github.com/reddio-com/contract_sample/blob/main/src/contracts/ERC721MintFor.sol#L82](https://github.com/reddio-com/contract_sample/blob/main/src/contracts/ERC721MintFor.sol#L82)) function.
...
If you want to mint NFT on Layer2, you need to have a contract on layer 1 with the [mintFor]([https://github.com/reddio-com/contract_demo/blob/main/src/contracts/ERC721MintFor.sol#L82](https://github.com/reddio-com/contract_demo/blob/main/src/contracts/ERC721MintFor.sol#L82) ) function in the contract. When you withdraw the NFT on layer1 to the Ethereum wallet, you are actually calling the Mintfor function and minting the NFT of the corresponding tokenID. 
