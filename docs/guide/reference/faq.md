...
Yes, Reddio’s is a layer2 blockchain for apps/games. Reddio is a service based on StarkEx, and all of StarkEx's data is on the ETH blockchain network. It's proof and funds (deposit/withdrawal) are all on the Ethereum mainnet. 
